    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Image
          source={
            profile.profilePhotoUrl
              ...
              : require('../assets/user-placeholder.png') // keep a placeholder image
          }
          style={styles.avatar}
        /> */}
        ...
        <View style={styles.card}>
          <ProfileRow label={t('business_name') ?? 'Business Name'} value={profile.businessName} />
          <ProfileRow label={t('business_id') ?? 'Business ID'} value={profile.businessId} />
          <ProfileRow label={t('location') ?? 'Location'} value={profile.location} />
        </View>
