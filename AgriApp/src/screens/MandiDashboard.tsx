...
// // import GraphChart,{QuantityBarChart,CropDistributionPieChart} from '../components/GraphChart';
...
// // ⬇️ from updated GraphChart.tsx
// import {
//   QuantityBarChart,
//   CropDistributionPieChart,
// } from '../components/GraphChart';
...
//     () => mockCropQuantity.reduce((s, i) => s + i.quantity, 0),
//     [],
//   );
//   const totalFarmers = 1248; // sample
//   const buyersCount = 456;
...
//             style={[
//               styles.smallBtn,
//               { borderColor: theme.text, backgroundColor: theme.primary },
//             ]}
//           >
...
//               {t('mandiDashboard') ?? 'Mandi Dashboard'}
//             </Text>
//             <Text style={[styles.sub, { color: theme.text }]}>
//               {t('delhiAzadpurMandi') ?? 'Azadpur Mandi, Delhi'}
//             </Text>
//           </View>
...
//           <View style={{ height: 220, marginTop: 10 }}>
//             <QuantityBarChart
//               data={mockCropQuantity.map(item => ({
//                 label: item.crop,
//                 value: item.quantity,
//               }))}
//             />
...
//         <View style={[styles.panel, { borderColor: theme.text }]}>
//           <Text style={[styles.panelTitle, { color: theme.text }]}>
//             {t('analytics') ?? 'Analytics of Crops'}
//           </Text>
//           <View style={{ height: 220, marginTop: 10 }}>
//             <CropDistributionPieChart data={distribution} />
//           </View>
//         </View>
...
//         <View style={[styles.panel, { borderColor: theme.text }]}>
//           <Text style={[styles.panelTitle, { color: theme.text }]}>
//             {t('auctionDate') ?? 'Auction Schedule'}
//           </Text>
//           <View style={{ marginTop: 12 }}>
//             {mockAuctionSchedule.map((a, idx) => (
//               <View
...
type MandiItem = { label: string; value: string };
...
export default function MandiDashboard({ navigation }: any) {
  ...
  const selectedMandiLabel =
    mandis.find(m => m.value === selectedMandiId)?.label ?? 'Select Mandi';
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.background }]}>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <View style={{ zIndex: 0 }}>
          ...
          {/* 🔹 Main Trend Chart (GraphChart) */}
          <View style={[styles.panel, { borderColor: theme.text }]}>
            <Text style={[styles.panelTitle, { color: theme.text }]}>
              {t('daily_market_price') ?? 'Daily Market Price'}
            </Text>
            <View style={{ height: 220, marginTop: 10 }}>
              <GraphChart filters={{ mandi: selectedMandiLabel }} />
            </View>
          </View>
