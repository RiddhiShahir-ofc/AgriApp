...
// // // type Lot = {
// // //   id: string; //preloaded LotId from backend
// // //   crop: string;
// // //   grade: string;
// // //   quantity: string;
// // //   mandi: string;
...
// // type Lot = {
// //   id: string; // this will be the preLotId from backend
// //   crop: string;
// //   grade: string;
// //   quantity: string;
// //   mandi: string;
...
// //   // 🔵 track if we are editing an existing lot
...
// //   // 🔵 helper: sync lots to AsyncStorage (for buyer pre-bidding etc.)
...
// //         return {
// //           id: String(id),
// //           crop: d.cropName ?? d.crop ?? '',
// //           grade: d.grade ?? '-',
// //           quantity: String(d.quantity ?? ''),
// //           mandi: d.mandiLocation ?? d.mandi ?? '',
// //           expectedArrival:
...
// //       // fallback: keep current lots if any
// //     }
// //   };

// //   // Load logged-in farmer and their lots from backend
// //   useEffect(() => {
...
// //   // 🔵 helper: reset lot form + editing state
// //   const resetLotForm = () => {
// //     setPrCrop('');
// //     setPrGrade('');
// //     setPrQuantity('');
...
// //   // 🔵 Register lot in backend & update UI + AsyncStorage
// //   const addLotInline = async () => {
// //     if (!prCrop)
// //       return Alert.alert(
// //         t('error_title') ?? 'Error',
...
// //       formData.append('crop', prCrop);
// //       formData.append('grade', prGrade || '-');
// //       formData.append('quantity', prQuantity);
// //       formData.append('mandi', prMandi);
// //       if (prExpectedArrival) {
// //         formData.append('expectedArrival', prExpectedArrival);
// //       }
...
// //       const id = String(
// //         data.preLotId ?? data.id ?? data.lotId ?? `${Date.now()}`,
// //       );

// //       const newLot: Lot = {
// //         id,
// //         crop: data.cropName ?? data.crop ?? prCrop,
// //         grade: data.grade ?? prGrade,
// //         quantity: String(data.quantity ?? prQuantity),
// //         mandi: data.mandiLocation ?? data.mandi ?? prMandi,
// //         expectedArrival:
...
// //       );
// //     // } catch (err) {
// //     //   console.error('Register lot error:', err);
// //     //   Alert.alert(
// //     //     t('error_title') ?? 'Error',
...
// //   // 🔵 start editing an existing lot (populate form)
...
// //     // try to parse date for date picker
...
// //         id: String(
// //           data.preLotId ?? data.id ?? data.lotId ?? editingLotId,
// //         ),
// //         crop: data.cropName ?? data.crop ?? prCrop,
// //         grade: data.grade ?? prGrade,
// //         quantity: String(data.quantity ?? prQuantity),
...
// //       );
// //     } catch (err) {
// //       console.error('Edit lot error:', err);
// //       Alert.alert(
// //         t('error_title') ?? 'Error',
...
// //       // You can choose to return here if you don't want to remove locally on failure
// //     }
